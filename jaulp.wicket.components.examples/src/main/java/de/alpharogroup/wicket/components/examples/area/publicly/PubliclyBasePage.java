...
public abstract class PubliclyBasePage<T> extends ApplicationBasePage<T> {
	...
	/**
	 * Instantiates a new {@link PubliclyBasePage} with the given
	...
	protected Navbar newNavbar(final String markupId) {
		...
		final IModel<String> brandNameModel = ResourceModelFactory.newResourceModel("global.slogan.mainhead.label",
				this);
		final IModel<String> overviewModel = ResourceModelFactory.newResourceModel("global.menu.overview.label", this);
		// show brand name
	...
	protected Component newFeaturesDropDownButton() {
		final IModel<String> featuresMainModel = ResourceModelFactory.newResourceModel("global.menu.features.label",
				this);
		...
		final IModel<String> downloadFileModel = ResourceModelFactory.newResourceModel("global.menu.download.pdf.label",
				this);
		final IModel<String> recaptchaModel = ResourceModelFactory.newResourceModel("global.menu.recaptcha.label",
				this);
		final IModel<String> sslRecaptchaModel = ResourceModelFactory
				.newResourceModel("global.menu.ssl.recaptcha.label", this);
		final IModel<String> wicketUrlsModel = ResourceModelFactory.newResourceModel("global.menu.wicket.urls.label",
				this);
		...
		final IModel<String> checkboxesModel = ResourceModelFactory.newResourceModel("global.menu.checkboxes.label",
				this);
		...
		final IModel<String> exceptionModel = ResourceModelFactory.newResourceModel("global.menu.exception.label",
				this);
		...
		final IModel<String> collapseExampleModel = ResourceModelFactory.newResourceModel("global.menu.collapse.label",
				this);
		final IModel<String> googlechartsExampleModel = ResourceModelFactory
				.newResourceModel("global.menu.googlecharts.label", this);
		final IModel<String> toastrExampleModel = ResourceModelFactory.newResourceModel("global.menu.toastr.label",
				this);
		...
		final IModel<String> tooltipsExampleModel = ResourceModelFactory.newResourceModel("global.menu.tooltips.label",
				this);
		return new NavbarDropDownButton(featuresMainModel) {
			...
			protected List<AbstractLink> newSubMenuButtons(final String buttonMarkupId) {
				...
				subMenu.add(new MenuBookmarkablePageLink<Void>(CollapsePage.class, collapseExampleModel)
						.setIconType(GlyphIconType.eyeopen));

				subMenu.add(new MenuBookmarkablePageLink<Void>(GoogleChartsExamplePage.class, googlechartsExampleModel)
						.setIconType(GlyphIconType.eyeopen));
				subMenu.add(new MenuBookmarkablePageLink<Void>(ReplaceWithPage.class, replaceWithPanelModel)
						.setIconType(GlyphIconType.eyeopen));
				subMenu.add(new MenuBookmarkablePageLink<Void>(PopupoverlayPage.class, popupoverlayPanelModel)
						.setIconType(GlyphIconType.eyeopen));
				subMenu.add(new MenuBookmarkablePageLink<Void>(EditableAjaxTabbedPage.class, tabsModel)
				...
				subMenu.add(new MenuBookmarkablePageLink<Void>(PdfDownloadPage.class, downloadFileModel)
				...
				subMenu.add(new MenuBookmarkablePageLink<Void>(SslReCaptchaPage.class, sslRecaptchaModel)
				...
				subMenu.add(new MenuBookmarkablePageLink<Void>(LabeledComponentsPage.class, labeledModel)
				...
				subMenu.add(new MenuBookmarkablePageLink<Void>(CheckboxesPage.class, checkboxesModel)
						.setIconType(GlyphIconType.book));
				subMenu.add(new MenuBookmarkablePageLink<Void>(RadioComponentsExamplePage.class, radiosModel)
						.setIconType(GlyphIconType.book));
				subMenu.add(new MenuBookmarkablePageLink<Void>(DeregistrationPage.class, deregistrationModel)
						.setIconType(GlyphIconType.book));
				subMenu.add(new MenuBookmarkablePageLink<Void>(NotificationExamplesPage.class, toastrExampleModel)
						.setIconType(GlyphIconType.barcode));
				subMenu.add(new MenuBookmarkablePageLink<Void>(SocialNetworksExamplePage.class, socialNetExampleModel)
						.setIconType(GlyphIconType.eyeopen));
				...
				subMenu.add(new MenuBookmarkablePageLink<Void>(TooltipsExamplePage.class, tooltipsExampleModel)
	...
	/**
	 * Factory method for creating a new dropdown navbar item for the legal
	 * issues like term of use.
	 *
	 * @return the component
	 */
	protected Component newLegalDropDownButton() {
		...
		final IModel<String> termOfUseModel = ResourceModelFactory.newResourceModel("global.menu.termofuse.label",
				this);
		final IModel<String> copyrightModel = ResourceModelFactory.newResourceModel("global.menu.copyright.label",
				this);
		return new NavbarDropDownButton(legacyMainModel) {
			...
			protected List<AbstractLink> newSubMenuButtons(final String buttonMarkupId) {
				...
				subMenu.add(new MenuBookmarkablePageLink<TermOfUsePage>(TermOfUsePage.class, termOfUseModel)
						.setIconType(GlyphIconType.picture));
				subMenu.add(new MenuBookmarkablePageLink<ImprintPage>(ImprintPage.class, copyrightModel)
						.setIconType(GlyphIconType.lock));
	...
	/**
	 * Factory method for creating a new dropdown navbar item for the bootstrap
	 * themes.
	 *
	 * @return the component
	 */
