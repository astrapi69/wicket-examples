...
public class LabeledHomePage extends BasePage
{
	...
	public LabeledHomePage(final PageParameters parameters)
	{
		...
		final LabeledTextFieldPanel<String,Member> nameTextField = new LabeledTextFieldPanel<>("name",
			cpm, Model.of("Name:"));

		form.add(nameTextField);

		final LabeledTextAreaPanel<String,Member> about = new LabeledTextAreaPanel<>("about", cpm,
			Model.of("About:"));
		form.add(about);

		final LabeledCheckboxPanel<String,Member> married = new LabeledCheckboxPanel<>("married", cpm,
			Model.of("Married:"));
		...
		final LabeledDateTimeFieldPanel<String,Member> dateofMarriage = new LabeledDateTimeFieldPanel<>(
