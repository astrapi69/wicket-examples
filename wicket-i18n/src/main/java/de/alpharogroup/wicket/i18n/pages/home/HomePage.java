...
public class HomePage extends WebPage {
	...
	public HomePage(final PageParameters parameters) {
		...
		add(new DynamicValuesPanel("dynamicValuesPanel", Model.<Summary>of(
				Summary.builder()
				.otherCount("5")
		...
		add(new PropertyBasedPanel("propertyBasedPanelLong",  Model.<Summary>of(
				Summary.builder()
				.otherCount("5")
				.title("Wicket in Action")
				.rate("excellent")
		...
		add(new PropertyBasedPanel("propertyBasedPanelShort",  Model.<Summary>of(
				Summary.builder()
				.otherCount("5")
				.title("Wicket in Action")
				.rate("excellent")
				.messagePreferences(MessagePreferences.SHORT)
				.build())));
